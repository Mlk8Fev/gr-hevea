            ...
            <div class="col-12">
                <div class="card p-24 radius-12 border-0 shadow-sm">
                    <div class="d-flex align-items-center justify-content-between mb-20">
                        ...
                        <a href="#" class="btn btn-primary text-sm btn-sm px-12 py-12 radius-8 d-flex align-items-center gap-2" onclick="alert('Création de coopérative non autorisée pour les Chef Secteur')">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center align-items-center gap-2">
                                            ...
                                            @if(!in_array(auth()->user()->role, ['agc', 'cs']))
                                            <form action="#" method="POST" class="d-inline" onsubmit="alert('Suppression non autorisée pour les Chef Secteur'); return false;">
                                                @csrf
                                                @method('DELETE')
