    ...
    <div class="dashboard-main-body">
        ...
        <div class="alert alert-info mb-4">
            ...
            @if(auth()->user()->role === 'agc')
                En tant qu'Agent gestion de qualité, vous visualisez les factures de toutes les coopératives de votre secteur ({{ auth()->user()->secteur }}).
            @else
                En tant que Chef Secteur, vous visualisez les factures de toutes les coopératives de votre secteur ({{ auth()->user()->secteur }}).
            @endif
        </div>
