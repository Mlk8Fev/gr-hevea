...
<head>
    ...
    <title>Créer un Centre de Transit - FPH-CI</title>
...
<main class="dashboard-main">
    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Créer un Centre de Transit</h6>
                ...
                <form action="{{ route('admin.centres-collecte.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('adresse') is-invalid @enderror" 
                                  ...
                                  placeholder="Adresse complète du centre de transit" required>{{ old('adresse') }}</textarea>
                        @error('adresse')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
