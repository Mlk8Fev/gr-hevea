                        ...
                        <form action="{{ route('admin.producteurs.documents.update', ['producteur' => $producteur->id, 'document' => $document->id]) }}" method="POST" enctype="multipart/form-data" id="selfdeclaration-form">
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="position_code_postal" value="{{ $data['position_code_postal'] ?? '' }}" placeholder="Ex: 01 BP 1234 Abidjan 01">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Fonction</label>
                                    <input type="text" class="form-control" name="fonction" value="{{ $data['fonction'] ?? '' }}" placeholder="Ex: Planteur, Producteur">
                                </div>
                                <div class="col-md-6">
