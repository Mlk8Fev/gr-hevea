            ...
            <div class="card-body p-24">
                <form action="{{ route('admin.connaissements.store') }}" method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('lieu_depart') is-invalid @enderror" 
                                       ...
                                       placeholder="Ex: Abengourou, San-Pédro, etc." required>
                                @error('lieu_depart')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('sous_prefecture') is-invalid @enderror" 
                                       id="sous_prefecture" name="sous_prefecture" value="{{ old('sous_prefecture') }}" 
                                       placeholder="Ex: Abengourou, San-Pédro, etc." required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('transporteur_nom') is-invalid @enderror" 
                                       id="transporteur_nom" name="transporteur_nom" value="{{ old('transporteur_nom') }}" 
                                       placeholder="Nom de l'entreprise de transport" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('transporteur_immatriculation') is-invalid @enderror" 
                                       id="transporteur_immatriculation" name="transporteur_immatriculation" value="{{ old('transporteur_immatriculation') }}" 
                                       placeholder="Ex: 123-AB-456" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('chauffeur_nom') is-invalid @enderror" 
                                       id="chauffeur_nom" name="chauffeur_nom" value="{{ old('chauffeur_nom') }}" 
                                       placeholder="Nom complet du chauffeur" required>
                                @error('chauffeur_nom')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('nombre_sacs') is-invalid @enderror" 
                                       id="nombre_sacs" name="nombre_sacs" value="{{ old('nombre_sacs') }}" 
                                       placeholder="Nombre total de sacs" min="1" required>
                                @error('nombre_sacs')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('poids_brut_estime') is-invalid @enderror" 
                                       id="poids_brut_estime" name="poids_brut_estime" value="{{ old('poids_brut_estime') }}" 
                                       placeholder="Poids estimé en kg" min="0.01" required>
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <h6 class="fw-semibold mb-3 text-primary">
                                <iconify-icon icon="majesticons:signature-line" class="icon me-2"></iconify-icon>
                                Signature
                            </h6>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('signature_cooperative') is-invalid @enderror" 
                                          id="signature_cooperative" name="signature_cooperative" rows="3" 
                                          placeholder="Signature du représentant de la coopérative">{{ old('signature_cooperative') }}</textarea>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="ri-save-line me-1"></i> Créer le Connaissement
                        </button>
                    </div>
                </form>
            </div>
