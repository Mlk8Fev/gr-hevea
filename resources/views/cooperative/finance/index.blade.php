                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($prix && !isset($prix['erreur']))
                                            <span class="fw-semibold text-success">{{ number_format($prix['prix_final_public'], 0) }} FCFA</span>
                                        @else
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex justify-content-center align-items-center gap-2">
                                            <a href="{{ route('cooperative.finance.show-calcul', $ticket->id) }}" class="bg-info-focus bg-hover-info-200 text-info-600 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle border-0" title="Voir calcul">
