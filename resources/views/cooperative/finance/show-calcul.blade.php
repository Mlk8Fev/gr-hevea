    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            ...
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">
                    <a href="{{ route('cooperative.finance.index') }}" class="hover-text-primary">Finance</a>
                </li>
                <li>-</li>
        ...
        <div class="text-center">
            <a href="{{ route('cooperative.finance.index') }}" class="btn btn-outline-secondary px-24 py-12 radius-8">
