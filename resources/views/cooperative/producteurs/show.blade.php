...
<head>
    ...
    <title>Profil Producteur - FPH-CI</title>
                        ...
                        <ul class="list-group radius-8">
                            <li class="list-group-item border text-secondary-light p-16 bg-base border-bottom-0">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="d-flex"><i class="ri-map-pin-line text-xl text-info"></i></span>
                                    <span class="fw-semibold">Secteur :</span> {{ $producteur->secteur ? $producteur->secteur->code . ' - ' . $producteur->secteur->nom : '-' }}
                                </div>
                            </li>
                            <li class="list-group-item border text-secondary-light p-16 bg-base border-bottom-0">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="d-flex"><i class="ri-phone-line text-xl text-warning"></i></span>
                                    <span class="fw-semibold">Contact :</span> {{ $producteur->contact }}
                                </div>
                            </li>
                            <li class="list-group-item border text-secondary-light p-16 bg-base border-bottom-0">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="d-flex"><i class="ri-landscape-line text-xl text-secondary"></i></span>
                                    <span class="fw-semibold">Superficie totale :</span> {{ $producteur->superficie_totale }} ha
                                </div>
                            </li>
                            <li class="list-group-item border text-secondary-light p-16 bg-base border-bottom-0">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="d-flex"><i class="ri-user-line text-xl text-success"></i></span>
                            ...
                            <li class="list-group-item border text-secondary-light p-16 bg-base border-bottom-0">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="d-flex"><i class="ri-id-card-line text-xl text-info"></i></span>
                            ...
                            <li class="list-group-item border text-secondary-light p-16 bg-base">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="d-flex"><i class="ri-map-2-line text-xl text-warning"></i></span>
                    ...
                    <div class="card-body p-24">
                        <ul class="list-group radius-8">
                            ...
                            <li class="list-group-item border text-secondary-light p-16 bg-base {{ !$loop->last ? 'border-bottom-0' : '' }}">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="d-flex"><i class="ri-building-line text-xl text-primary"></i></span>
                ...
                <div class="card mb-24 radius-12">
                    <div class="card-header border-bottom bg-base py-16 px-24">
                        <h6 class="text-lg fw-semibold mb-0">
                            <i class="ri-landscape-line me-2 text-primary"></i>
