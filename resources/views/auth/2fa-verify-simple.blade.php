        ...
        <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
            <div class="max-w-464-px mx-auto w-100">
                ...
                <form action="{{ route('2fa.verify') }}" method="POST">
                    @csrf
                    <div class="mb-20">
                        <label for="code" class="form-label fw-semibold text-primary-light text-sm mb-8">Code de vérification <span class="text-danger-600">*</span></label>
                        <input type="text" 
                               name="code" 
                               id="code"
                               class="form-control radius-8 h-56-px text-center" 
                               placeholder="123456" 
                               maxlength="6"
                               pattern="[0-9]{6}"
                               autofocus
                    ...
                    <button type="submit" class="btn btn-primary text-sm btn-sm px-12 py-16 w-100 radius-8 mt-32">
                        Vérifier et accéder
                    </button>
                </form>
