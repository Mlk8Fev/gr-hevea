...
class AgcFactureController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('agc.factures.index', compact('factures', 'secteurs', 'cooperatives', 'types', 'statuts', 'navigation'));
    }
    ...
    {
        return redirect()->route('agc.factures.index')->with('info', 'La création de factures est réservée aux administrateurs.');
    }
    ...
    public function show(Facture $facture)
    {
        ...
        if (!$facture->cooperative || $facture->cooperative->secteur->code !== $secteurCode) {
            return redirect()->route('agc.factures.index')->with('error', 'Accès refusé.');
        }
        ...
        return view('agc.factures.show', compact('facture', 'ticketsAvecPrix', 'navigation'));
    }
    ...
    public function preview(Facture $facture)
    {
        ...
        return view('agc.factures.preview-individuelle', compact('facture', 'ticketsAvecPrix', 'navigation'));
    }
    ...
    public function pdf(Facture $facture)
    {
        ...
        $pdf = \PDF::loadView('agc.factures.pdf-compact', compact('facture', 'ticketsAvecPrix'));
