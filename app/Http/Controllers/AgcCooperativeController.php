...
class AgcCooperativeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('agc.cooperatives.index', compact('cooperatives', 'secteurs', 'navigation'));
    }
    ...
    public function show($id)
    {
        ...
        return view('agc.cooperatives.show', compact('cooperative', 'navigation') + ['documentTypes' => $this->documentTypes]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('agc.cooperatives.edit', compact('cooperative', 'secteurs', 'centresCollecte', 'navigation') + ['documentTypes' => $this->documentTypes]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // Vérifier que l'AGC/CS ne peut voir que les coopératives de son secteur
        ...
        // Pour les AGC/CS, traiter uniquement les documents
        if (in_array(auth()->user()->role, ['agc', 'cs'])) {
            ...
            if ($documentsProcessed) {
                return redirect()->route('agc.cooperatives.show', $cooperative)
    ...
    public function documents($id)
    {
        ...
        return view('agc.cooperatives.documents', compact('cooperative', 'navigation') + ['documentTypes' => $this->documentTypes]);
    }
    ...
    public function storeDocument(Request $request, $id)
    {
        ...
        return redirect()->route('agc.cooperatives.documents', $cooperative)
